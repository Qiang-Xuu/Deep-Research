...
Read `~/.claude/skills/xq-card/assets/sketchnote_template.html`
...
写入：`/tmp/xq_cast_sketchnote_{name}.html`
...
```bash
node ~/.claude/skills/xq-card/assets/capture.js /tmp/xq_cast_sketchnote_{name}.html ~/Downloads/{name}.png 1080 800 fullpage
```
