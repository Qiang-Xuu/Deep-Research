...
Read `~/.claude/skills/xq-card/assets/poster_template.html`
...
写入：`/tmp/xq_cast_poster_{name}_{N}.html`

## 步骤 7：截图

```bash
node ~/.claude/skills/xq-card/assets/capture.js /tmp/xq_cast_poster_{name}_{N}.html ~/Downloads/{name}_{N}.png 1080 1440
```
